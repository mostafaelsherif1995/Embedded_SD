 ...
 * FAT32.c
 *
 * Created: 03--Aug--2021 2:57:51 PM
 *  Author: Pc
 */ 
...
volatile unsigned char _token;
//////////////////////function to add fat32
unsigned char SD_readSingleBlock(unsigned long add){
	
	SdCard_ReadSingleBlock(add, buffer, &_token);
}
unsigned char SD_writeSingleBlock(unsigned long add){
	SdCard_WriteSingleBlock(add, buffer, &_token);
}
...
while(1)
{
  ...
  for(j=0; j<sectorPerCluster; j++)
  {
	...
	for(k=0; k<512; k++)
    {
		if(buffer[k]==','||buffer[k]==';'||buffer[k]==',') transmitString("      ");
     else  transmitByte(buffer[k]);
...
if(j == 1) 
{
 transmitString(" File already exists, appending data.."); 
  appendFile = 1;
...
else
{
 ...
 int count=0;
  dataString[count++]='D'; dataString[count++]='a'; dataString[count++]='t'; dataString[count++]='e'; dataString[count++]=',' ;
  dataString[count++]='T'; dataString[count++]='i'; dataString[count++]='m'; dataString[count++]='e'; dataString[count++]=',' ;
  dataString[count++]='T'; dataString[count++]='e'; dataString[count++]='m'; dataString[count++]='p'; dataString[count++]='e'; dataString[count++]='r'; 
  dataString[count++]='a'; dataString[count++]='t'; dataString[count++]='u'; dataString[count++]='r'; dataString[count++]='e'; dataString[count++]=' '; 
  dataString[count++]='C';  dataString[count++]=',';
 dataString[count++]='H';    dataString[count++]='u';    dataString[count++]='m';    dataString[count++]='i';    dataString[count++]='d';
 dataString[count++]='i';    dataString[count++]='t';    dataString[count++]='y';    dataString[count++]=' ';    dataString[count++]='%';    dataString[count++]=',';
  
 dataString[count++] = '\r';	dataString[count++] = '\n'; 
